...
describe("UCSBOrganizationIndexPage tests", () => {
  ...
  test("renders three UCSB Organizations correctly for regular user", async () => {
    ...
    const orgTranslatonShort = screen.getByText("SKYDIVING CLUB");
    expect(orgTranslatonShort).toBeInTheDocument();
  ...
  test("what happens when you click delete, admin", async () => {
    ...
    axiosMock
      ...
      .reply(200, "UCSBOrganization with org code ZPR was deleted");
    ...
    await waitFor(() => {
      expect(mockToast).toBeCalledWith(
        "UCSBOrganization with org code ZPR was deleted",
      );
    });
